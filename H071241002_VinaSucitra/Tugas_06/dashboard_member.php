...
<head>
    ...
    <title>Dashboard Team Member | VS manajemen</title>
    <script src="https://cdn.tailwindcss.com"></script>
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.0.0-beta3/css/all.min.css" />

    <style>
        body { background-color: #1a0b1f; font-family: 'Inter', sans-serif; color: #fdf2f8; min-height: 100vh; }
...
<body class="text-pink-50">
    ...
    <!-- HEADER -->
    <header class="bg-header p-4 shadow-2xl sticky top-0 z-10 border-b border-pink-700">
        <div class="max-w-7xl mx-auto flex justify-between items-center">
            <h1 class="text-xl md:text-2xl font-extrabold text-pink-400 tracking-wider">
                <i class="fas fa-tasks mr-2"></i> VS Team Member
            </h1>
            <div class="flex items-center gap-4">
                <span class="text-pink-200 text-xs md:text-sm">
                    <strong class="font-bold text-pink-50"><?= htmlspecialchars($_SESSION['username']); ?></strong>
                    <span class="text-pink-400">(Team Member)</span>
                </span>
