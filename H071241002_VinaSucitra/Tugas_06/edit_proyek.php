...
$tasks_q = $conn->query("
    ...
    ORDER BY t.id DESC
");//desc artinya data terbaru akan muncul di paling atas
//left join artinya ambil semua data dari tabel tasks (t) dan jika ada data yang sesuai di tabel users (u) maka gabungkan, jika tidak ada tetap ambil data dari tasks
...
if (isset($_GET['task_id'])) {
    ...
    }//num_rows berfungsi untuk menghitung jumlah baris hasil query
    //fetch_assoc berfungsi untuk mengambil hasil query sebagai array associative
}
?>
