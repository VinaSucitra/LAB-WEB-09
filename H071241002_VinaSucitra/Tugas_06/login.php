...
<head>
    ...
    <title>Login - VS Manajemen</title>
...
<body class="flex items-center justify-center min-h-screen px-4">
    ...
    <div class="bg-[#1a001f]/90 border border-pink-600 rounded-2xl p-8 w-full max-w-md glow backdrop-blur-sm">
        <h1 class="text-center text-4xl font-extrabold text-pink-400 glow-text mb-3">VS Manajemen</h1>
        ...
        <p class="text-center text-sm text-pink-300 mt-6 opacity-80">© <?= date("Y") ?> Dibuat oleh Vina Sucitra</p>
    </div>
