...
if (isset($_POST['tambah_user'])) {
    ...
    // Validasi awal: field tidak kosong
    ...
    // -- HAPUS: cek username === password (sesuai permintaan)
    // -- HAPUS: cek apakah password sudah dipakai user lain (sesuai permintaan)

    // 1) Cek apakah username sudah ada di DB (wajib)
...
<head>
    ...
    <title>Super Admin Dashboard | Vs Manajemen</title>
...
<body>
    ...
    <header class="bg-[#2a0e30] p-4 flex justify-between items-center shadow-xl border-b border-pink-700">
        <h1 class="text-2xl font-extrabold text-pink-400 tracking-wider">
            VS <span class="text-pink-100 font-light">ADMIN</span>
        </h1>
